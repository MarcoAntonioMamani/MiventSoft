...
#End Region
    ...
    Private Sub MetroTileItem11_Click_3(sender As Object, e As EventArgs) Handles MetroTileItem11.Click

    End Sub

    Private Sub MetroTileItem12_Click_1(sender As Object, e As EventArgs) Handles MetroTileItem12.Click
