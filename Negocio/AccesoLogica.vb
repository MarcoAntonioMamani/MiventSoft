...
#Region "TY006 Categorias"
    ...
    Public Shared Function L_fnPedidosEstados() As DataTable
        Dim _Tabla As DataTable
...
#Region "Despacho Productos"
    ...
    Public Shared Function DatosreporteCierreCaja(CierreCajaId As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Ventas TecBrinc"
    ...
    Public Shared Function ListaPedidosAsignadosByChofer(ChoferId As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "Compras TecBrinc"
    ...
    Public Shared Function ReporteHistoricoCobrosbyVendedor(FechaI As String, FechaF As String, PersonalId As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function ReporteVentasPorProductos(FechaI As String, FechaF As String, ProductoId As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ReporteComprasPorProductos(FechaI As String, FechaF As String, ProductoId As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ReporteVentasAtendidasTodosUnCliente(FechaI As String, FechaF As String, IdCLiente As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ListarProductosBuscador() As DataTable
        Dim _Tabla As DataTable
...
#Region "Producto TecBrinc"
    ...
    Public Shared Function L_prListarGeneralFechas(NameSp As String, Fechadesde As String, FechaHasta As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 3))
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        _listParam.Add(New Datos.DParametro("@desde", Fechadesde))
        _listParam.Add(New Datos.DParametro("@hasta", FechaHasta))
...
#Region "Usuarios TecBrinc"
    ...
    Public Shared Function L_prGenerarReporteProductosPorVentas(ProveedorId As Integer, CategoriaID As Integer, ClienteId As Integer,
                                                                FechaI As String, FechaF As String, IdProducto As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prListarProductosPorCategoriaTotalV2PorCategoria(FechaI As String,
                                                           FechaF As String,
                                                           PersonalId As Integer, CategoriaId As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prListarHistorico(idPersonal As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 13))
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        _listParam.Add(New Datos.DParametro("@idVendedor", idPersonal))
        _listParam.Add(New Datos.DParametro("@fechI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _Tabla = D_ProcedimientoConParam("MAM_Clientes", _listParam)
