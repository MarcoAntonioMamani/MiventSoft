...
#Region "Ventas TecBrinc"
    ...
    Public Shared Function VentaInsertar(ByRef _numi As String, AlmacenId As Integer,
       ...
       FechaVencCredito As String, Moneda As Integer, estado As Integer, glosa As String,
                                           TotalCompra As Double, _dtDetalle As DataTable,
                                           Descuento As Double, dtPago As DataTable, Facturado As Integer, PorcentajeComision As Double) As Boolean
        Dim _resultado As Boolean
...
#Region "Compras TecBrinc"
    ...
    Public Shared Function ReporteVentasRendimientoCliente(FechaI As String, FechaF As String, dt As DataTable) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ReporteListarVentas(FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Categoria TecBrinc"
    ...
    Public Shared Function L_prCuentasGeneral() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prCuentasCombo() As DataTable
        Dim _Tabla As DataTable
...
#Region "Conceptos Fijos"
    ...
    Public Shared Function L_prListarCuentasVentas(PersonalId As Integer, Fecha As String, SucursalId As Integer) As DataTable
        Dim _Tabla As DataTable
