...
#Region "Ventas TecBrinc"
    ...
    Public Shared Function pr_ObtenerDeuda(ClienteId As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function ActualizarAEntregado(VentaId As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function ActualizarAPendienteEntrega(VentaId As Integer) As Boolean
        Dim _resultado As Boolean
...
#Region "Compras TecBrinc"
    ...
    Public Shared Function ReporteVentasAtendidasTodosDetallado(FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Movimientos TecBrinc"
    ...
    Public Shared Function L_prListarProductosTodosInventarioUnaSucursal(CategoriaPrecio As Integer, DepositoId As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "Producto TecBrinc"
    ...
    Public Shared Function L_prProductoInsertar(ByRef _numi As String, _CodigoExterno As String,
        ...
        _conversion As Double, _dtImagenes As DataTable, dtPrecio As DataTable) As Boolean
        Dim _resultado As Boolean
...
#Region "Cuentas por Pagar"
    ...
    Public Shared Function L_prListarPagosPendientesClientesDetallado() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prGrabarPagosCreditoVentas(ByRef TransaccionVentaId As String,
        CreditoVentaId As Integer, FechaPAgo As String, PersonalId As Integer, Glosa As String,
        NroComprobante As String, Pago As Double, Efectivo As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@Monto", Pago))
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        _listParam.Add(New Datos.DParametro("@Efectivo", Efectivo))
        _Tabla = D_ProcedimientoConParam("MAM_CreditosVentas", _listParam)
