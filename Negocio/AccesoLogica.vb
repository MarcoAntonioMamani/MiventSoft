...
#Region "Clientes Tec"
    ...
    Public Shared Function InsertarCliente(_Id As String, IdZona As Integer, IdPrecio As Integer, CodigoExterno As String, NombreCliente As String,
                                           ...
                                           Longitud As Double, TipoNegocio As Integer, Referencia As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "Producto TecBrinc"
    ...
    Public Shared Function L_prProductoInsertarKailin(ByRef _numi As String, _CodigoExterno As String,
                                                _CodigoBarra As String, _NombreProducto As String,
        _Descripcion As String, _stockMinimo As Decimal, _estado As Integer, _CategoriaId As Integer, _EmpresaId As Integer, _ProveedorId As Integer, _MarcaId As Integer,
        _AttributoId As Integer, _FamiliaId As Integer, _UnidadVentaId As Integer, _UnidadMaximaId As Integer,
        _conversion As Double, _dtImagenes As DataTable, PrecioCosto As Double, PrecioFacturado As Double, PrecioMayorista As Double) As Boolean
        Dim _resultado As Boolean
    ...
    Public Shared Function L_prProductoInsertarDistralKCP(ByRef _numi As String, _CodigoExterno As String,
                                                _CodigoBarra As String, _NombreProducto As String,
        _Descripcion As String, _stockMinimo As Decimal, _estado As Integer, _CategoriaId As Integer, _EmpresaId As Integer, _ProveedorId As Integer, _MarcaId As Integer,
        _AttributoId As Integer, _FamiliaId As Integer, _UnidadVentaId As Integer, _UnidadMaximaId As Integer,
        _conversion As Double, _dtImagenes As DataTable, costo As Decimal,
        venta As Decimal) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        '_listParam.Add(New Datos.DParametro("@Facturado", PrecioFacturado))
        _listParam.Add(New Datos.DParametro("@compra", costo))
