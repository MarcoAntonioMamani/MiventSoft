...
#Region "Ventas TecBrinc"
    ...
    Public Shared Function VentaInsertarDespacho(ByRef _numi As String, Observacion As String, PersonalId As Integer, Despachado As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 11))
        _listParam.Add(New Datos.DParametro("@VentaId", _numi))
        _listParam.Add(New Datos.DParametro("@PersonalId", PersonalId))
        _listParam.Add(New Datos.DParametro("@ObservacionDespacho", Observacion))
        _listParam.Add(New Datos.DParametro("@Despachado", Despachado))
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        _Tabla = D_ProcedimientoConParam("MAM_Ventas", _listParam)
