...
#Region "Ventas TecBrinc"
    ...
    Public Shared Function ListaVentasDescuento(VentaId As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "Compras TecBrinc"
    ...
    Public Shared Function ObtenerImagenEmpresa(id As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "Movimientos TecBrinc"
    ...
    Public Shared Function L_prListarProductosLotePreciosGeneral() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prListarProductosTodosInventarioPrecioCompraJhon(CategoriaPrecio As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@usuario", L_Usuario))
        _listParam.Add(New Datos.DParametro("@DepositoId", CategoriaPrecio))
        _Tabla = D_ProcedimientoConParam("MAM_Movimientos", _listParam)
