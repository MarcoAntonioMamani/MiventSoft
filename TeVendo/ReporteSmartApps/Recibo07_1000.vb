...
Public Class Recibo07_1000
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Recibo07_1000.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecibo07_1000
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Recibo07_1000 = New Recibo07_1000()
        rpt.Site = Me.Site
        Return rpt
    End Function
