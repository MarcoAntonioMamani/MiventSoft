...
Public Class Rep_CierreCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Rep_CierreCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_CierreCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_CierreCaja = New Rep_CierreCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
