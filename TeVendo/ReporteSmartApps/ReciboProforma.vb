...
Public Class ReciboProforma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.ReciboProforma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciboProforma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboProforma = New ReciboProforma()
        rpt.Site = Me.Site
        Return rpt
    End Function
