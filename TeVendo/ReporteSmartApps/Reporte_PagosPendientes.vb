...
Public Class Reporte_PagosPendientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_PagosPendientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Reporte_PagosPendientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_PagosPendientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_PagosPendientes = New Reporte_PagosPendientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
