...
Public Class Reporte_Movimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Reporte_Movimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Movimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Movimiento = New Reporte_Movimiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
