...
Public Class Reporte_Entregas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Reporte_Entregas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Entregas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Entregas = New Reporte_Entregas()
        rpt.Site = Me.Site
        Return rpt
    End Function
