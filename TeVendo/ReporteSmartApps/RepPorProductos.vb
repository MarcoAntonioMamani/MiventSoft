...
Public Class RepPorProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.RepPorProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPorProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPorProductos = New RepPorProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
