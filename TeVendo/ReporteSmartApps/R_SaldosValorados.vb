...
Public Class R_SaldosValorados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.R_SaldosValorados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SaldosValorados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SaldosValorados = New R_SaldosValorados()
        rpt.Site = Me.Site
        Return rpt
    End Function
