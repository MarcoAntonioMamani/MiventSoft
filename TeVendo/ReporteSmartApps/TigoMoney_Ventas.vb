...
Public Class TigoMoney_Ventas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.TigoMoney_Ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTigoMoney_Ventas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TigoMoney_Ventas = New TigoMoney_Ventas()
        rpt.Site = Me.Site
        Return rpt
    End Function
