...
Public Class Reporte_Cobros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Reporte_Cobros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Cobros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Cobros = New Reporte_Cobros()
        rpt.Site = Me.Site
        Return rpt
    End Function
