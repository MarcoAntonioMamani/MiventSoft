...
Public Class ReporteJhonSaldo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.ReporteJhonSaldo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteJhonSaldo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteJhonSaldo = New ReporteJhonSaldo()
        rpt.Site = Me.Site
        Return rpt
    End Function
