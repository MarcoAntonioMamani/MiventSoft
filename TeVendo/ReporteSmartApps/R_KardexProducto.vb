...
Public Class R_KardexProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.R_KardexProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_KardexProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_KardexProducto = New R_KardexProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
