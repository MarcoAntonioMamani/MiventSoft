...
Public Class R_ReporteSaldoFamilia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_ReporteSaldoFamilia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteSaldoFamilia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteSaldoFamilia = New R_ReporteSaldoFamilia()
        rpt.Site = Me.Site
        Return rpt
    End Function
