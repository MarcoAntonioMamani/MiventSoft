...
Public Class Rep_PagosCreditos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Rep_PagosCreditos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRep_PagosCreditos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_PagosCreditos = New Rep_PagosCreditos()
        rpt.Site = Me.Site
        Return rpt
    End Function
