...
Public Class VentasVsCostos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.VentasVsCostos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasVsCostos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasVsCostos = New VentasVsCostos()
        rpt.Site = Me.Site
        Return rpt
    End Function
