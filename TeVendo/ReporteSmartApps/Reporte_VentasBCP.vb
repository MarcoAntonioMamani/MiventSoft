...
Public Class Reporte_VentasBCP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.Reporte_VentasBCP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_VentasBCP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_VentasBCP = New Reporte_VentasBCP()
        rpt.Site = Me.Site
        Return rpt
    End Function
