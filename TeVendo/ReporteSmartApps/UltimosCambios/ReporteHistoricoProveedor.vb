...
Imports System.IO
Public Class ReporteHistoricoProveedor
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE HISTORICO POR PROVEEDOR"
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        If (chkTodos.Checked = True) Then
            ...
            dt = ReporteHistoricoProveedorTodos(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        Else
            If (IdPersonal > 0) Then

                dt = ReporteHistoricoProveedorTodosUnProveedor(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"), IdPersonal)
            Else
                tbVendedor.Focus()
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        Dim _dt As New DataTable
            ...
            Dim objrep As New Reporte_HistoricoProveedor
