...
Public Class Form_ClientesQueMasCompran
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE CLIENTES QUE MAS COMPRAN"
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        dt = ReporteHistoricoClientesQueMasCompran(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New RptClienteQueMasCompran
