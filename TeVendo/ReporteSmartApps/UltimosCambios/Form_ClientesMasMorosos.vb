...
Public Class Form_ClientesMasMorosos
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE CLIENTES MAS MOROSOS"
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        dt = ReporteClientesMorosos(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New Rep_ClientesMorosos
