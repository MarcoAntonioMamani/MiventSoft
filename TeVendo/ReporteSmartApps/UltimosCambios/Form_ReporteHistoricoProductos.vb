...
Imports System.IO
Public Class Form_ReporteHistoricoProductos
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE HISTORICO POR PRODUCTO"
    ...
    Private Sub tbVendedor_KeyDown(sender As Object, e As KeyEventArgs) Handles tbVendedor.KeyDown
        If e.KeyData = Keys.Control + Keys.Enter Then
            ...
            If (bandera = True) Then
                ...
                tbVendedor.Text = Row.Cells("NombreCategoria").Value
                cbFechaDesde.Focus()
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        If (chkTodos.Checked = True) Then
            ...
            dt = ReporteHistoricoProductosTodos(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        Else
            If (IdPersonal > 0) Then

                dt = ReporteHistoricoProductosUnProducto(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"), IdPersonal)
            Else
                tbVendedor.Focus()
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New Reporte_HistoricoComprasProductos
