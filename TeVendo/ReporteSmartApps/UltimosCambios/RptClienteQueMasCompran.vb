...
Public Class RptClienteQueMasCompran
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptClienteQueMasCompran.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TeVendo.RptClienteQueMasCompran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptClienteQueMasCompran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptClienteQueMasCompran = New RptClienteQueMasCompran()
        rpt.Site = Me.Site
        Return rpt
    End Function
