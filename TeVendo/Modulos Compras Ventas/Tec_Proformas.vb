...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prCargarDetalleVenta(_numi As String)
        ...
        dt = ListaProformasDetalles(_numi)
...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Function _PMOGetTablaBuscador() As DataTable
        ...
        If gi_userRol = 1 Then
            dtBuscador = L_prListarVentasGeneralFiltroFecha("MAM_Proforma", tbDesde.Value.ToString("yyyy/MM/dd"), tbHasta.Value.ToString("yyyy/MM/dd"), Global_Sucursal)
