...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prCargarDetalleVenta(_numi As String)
        ...
        dt = ListaProformaDetalles(_numi)
...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Sub ReporteVenta(Id As String)
        ...
        ef.tipo = 8
        ef.titulo = "Comprobante de Proformas"
        ef.descripcion = "¿Desea Generar el Reporte de la Proforma #" + Id + " ?"
        ef.ShowDialog()
    ...
    Public Function _PMOGetTablaBuscador() As DataTable
        ...
        Dim dtBuscador As DataTable = L_prListarGeneralFechas("MAM_Proforma", cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        Return dtBuscador
    End Function
    ...
    Private Sub P_GenerarReporte(numi As String)
        Dim dt As DataTable = ListarProformaRecibo(numi)
