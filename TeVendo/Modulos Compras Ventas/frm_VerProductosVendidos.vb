...
Public Class frm_VerProductosVendidos
    ...
    Public dtTotalVenta As DataTable
    ...
    Public Sub New(dtv As DataTable, dtDescuento As DataTable)
        InitializeComponent()
        dtDetalle = dtv
        dtTotalVenta = dtDescuento

        tbMdesc.Value = dtDescuento.Rows(0).Item("Descuento")
    End Sub
