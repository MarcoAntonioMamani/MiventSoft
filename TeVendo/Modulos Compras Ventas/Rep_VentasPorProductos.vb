...
Imports System.IO
Public Class Rep_VentasPorProductos
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE DE VENTAS POR PRODUCTOS"
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        If (chkTodos.Checked = True) Then
            ...
            dt = ReporteVentasPorProductos(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"), IdProducto)
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        ...
        Dim _dt As New DataTable
            ...
            Dim objrep As New Reporte_VentaPorProductos
