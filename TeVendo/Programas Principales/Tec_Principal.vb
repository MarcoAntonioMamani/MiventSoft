...
#End Region
    ...
    Private Sub btnInvStockPrecio_Click(sender As Object, e As EventArgs) Handles btnInvStockPrecio.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New JhonInventarioCosto
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnInvStockPrecio.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
End Class