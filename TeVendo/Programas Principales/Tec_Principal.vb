...
#End Region
    ...
    Private Sub btnAsignacionPedidos_Click(sender As Object, e As EventArgs) Handles btnAsignacionPedidos.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Tec_AdministrarAsignacionesPedidos
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnAsignacionPedidos.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
    ...
    Private Sub btnHistorico_Click(sender As Object, e As EventArgs) Handles btnHistorico.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Tec_HistoricoPreciosCompra
    ...
    Private Sub btnCierreReporteGastos_Click(sender As Object, e As EventArgs) Handles btnCierreReporteGastos.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        'Dim frm As New F0_Roles
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnCierreReporteGastos.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnCierreRegistroIngresoEgresoGenerales_Click(sender As Object, e As EventArgs) Handles btnCierreRegistroIngresoEgresoGenerales.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        'Dim frm As New F0_Roles
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnCierreRegistroIngresoEgresoGenerales.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnCierreReporteAnual_Click(sender As Object, e As EventArgs) Handles btnCierreReporteAnual.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        'Dim frm As New F0_Roles
    ...
    Private Sub btnVentaProductos_Click(sender As Object, e As EventArgs) Handles btnVentaProductos.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Rep_VentasPorProductos
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnVentaProductos.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
    ...
    Private Sub btnComprasPorProducto_Click(sender As Object, e As EventArgs) Handles btnComprasPorProducto.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New FReporteCompraProducto
    ...
    Private Sub btnReporteCobranza_Click(sender As Object, e As EventArgs) Handles btnReporteCobranza.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Reporte_HistoricoCobro
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnReporteCobranza.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
    ...
    Private Sub btVentProforma_Click(sender As Object, e As EventArgs) Handles btVentProforma.Click
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btVentProforma.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnReporteProductoCategoria_Click(sender As Object, e As EventArgs) Handles btnReporteProductoCategoria.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New FrmVentasPorCategoria
