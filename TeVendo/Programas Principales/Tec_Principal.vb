...
#End Region
    ...
    Private Sub btnReporteServicioBCP_Click(sender As Object, e As EventArgs) Handles btnReporteServicioBCP.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Reporte_VentaBCP
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnReporteServicioBCP.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnReporteTigoMoney_Click(sender As Object, e As EventArgs) Handles btnReporteTigoMoney.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Reporte_PTigoMoney
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnReporteTigoMoney.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
End Class