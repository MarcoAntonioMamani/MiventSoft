...
#End Region
    ...
    Private Sub btConfDosificacion_Click(sender As Object, e As EventArgs) Handles btConfDosificacion.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        'Dim frm As New F0_Roles
        Dim frm As New Tec_Dosificacion
        frm._nameButton = btnConfCategoria.Name
        'frm._modulo = Panel_Configuracion
    ...
    Private Sub btnCierreCajero02_Click(sender As Object, e As EventArgs) Handles btnCierreCajero02.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Tec_CierreCajaCajero02
    ...
    Private Sub btnHistorico_Click(sender As Object, e As EventArgs) Handles btnHistorico.Click
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnHistorico.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnReporteHistoricoProveedor_Click(sender As Object, e As EventArgs) Handles btnReporteHistoricoProveedor.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New ReporteHistoricoProveedor
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnReporteHistoricoProveedor.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnHistoricoComprasProductos_Click(sender As Object, e As EventArgs) Handles btnHistoricoComprasProductos.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Form_ReporteHistoricoProductos
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnHistoricoComprasProductos.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btVentReporteUtilidadPorNota_Click(sender As Object, e As EventArgs) Handles btVentReporteUtilidadPorNota.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Form_UtilidadNotaVenta
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btVentReporteUtilidadPorNota.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnClientesQueMasCompran_Click(sender As Object, e As EventArgs) Handles btnClientesQueMasCompran.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Form_ClientesQueMasCompran
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnClientesQueMasCompran.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btnVentasMorosos_Click(sender As Object, e As EventArgs) Handles btnVentasMorosos.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Form_ClientesMasMorosos
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btnVentasMorosos.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub

    Private Sub btComReporteDadosBaja_Click(sender As Object, e As EventArgs) Handles btComReporteDadosBaja.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        Dim frm As New Form_ProductosDadoBaja
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        tab3.RecalcSize()
        tab3.ThemeAware = True
        tab3.ShowSubItems = True
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btComReporteDadosBaja.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
End Class