...
#End Region
    ...
    Private Sub btConfCuentas_Click(sender As Object, e As EventArgs) Handles btConfCuentas.Click
        SuperTabControlMenu.SelectedTab = tab_ventana
        'Dim frm As New F0_Roles
        Dim frm As New Form_Cuentas
        frm._nameButton = btnConfCategoria.Name
        'frm._modulo = Panel_Configuracion
        ...
        frm.Show()
        tab3.Text = frm.Text
        Dim blah As New Bitmap(btConfCuentas.Image, 20, 20)
        Dim ico As Icon = Icon.FromHandle(blah.GetHicon())
        tab3.Icon = ico
    End Sub
End Class