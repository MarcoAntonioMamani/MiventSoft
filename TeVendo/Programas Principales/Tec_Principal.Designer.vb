...
Partial Class Tec_Principal
    ...
    Private Sub InitializeComponent()
        ...
        Me.ItemContainer7.SubItems.AddRange(New DevComponents.DotNetBar.BaseItem() {Me.btnCompras, Me.btnCompraCredito, Me.btnProveedores, Me.btnReporteHistoricoProveedor})
        '
        '
        '
