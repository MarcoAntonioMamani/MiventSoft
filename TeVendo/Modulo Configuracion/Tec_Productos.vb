...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Function _PMOGetListEstructuraBuscador() As List(Of Celda)
        ...
        listEstCeldas.Add(New Celda("NombreProducto", True, " Nombre Comercial", 150))
        listEstCeldas.Add(New Celda("DescripcionProducto", True, " Descripcion", 200))
        ...
        listEstCeldas.Add(New Celda("Formulacion", True, "Formulacion", 90))
