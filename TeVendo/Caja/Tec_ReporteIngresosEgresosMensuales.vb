...
Public Class Tec_ReporteIngresosEgresosMensuales
    ...
    Public Sub ArmarTabla(ByRef dt As DataTable)
        ...
        For i As Integer = 1 To 12 Step 1
            ...
            Dim totalIngreso As Double = dtIngresoegreso.Compute("Sum(Monto)", "IngresoEgreso=1")
            Dim totalEgreso As Double = dtIngresoegreso.Compute("Sum(Monto)", "IngresoEgreso=0")
