...
Imports Janus.Data
Public Class Reporte_RendimientoVentasCliente
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE RENDIMIENTO DE CLIENTES"
    ...
    Private Sub _prCargarTablaVendedor()
        ...
        dt = ReporteListarVentas(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        ...
        With gr_Personal.RootTable.Columns("NombreCliente")
            .Width = 200
            .Caption = "Cliente"
            .Visible = True
            .WordWrap = True
            .MaxLines = 3
        End With
        With gr_Personal.RootTable.Columns("totalVenta")
            .Width = 120
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        If (ContarPersonalSeleccionado() = 0) Then
            ...
            ToastNotification.Show(Me, "Seleccione al menos un cliente Por Favor".ToUpper, img, 5000, eToastGlowColor.Red, eToastPosition.TopCenter)
            Return

        End If
        Dim _dt As New DataTable
        _dt = ReporteVentasRendimientoCliente(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"), CType(gr_Personal.DataSource, DataTable))
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New Reporte_Rendimiento_Cliente
