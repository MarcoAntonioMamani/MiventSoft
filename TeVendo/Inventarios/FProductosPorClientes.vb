...
Public Class FProductosPorClientes
    ...
    Private Sub cbPrecio_ValueChanged(sender As Object, e As EventArgs) Handles cbCategoriaProducto.ValueChanged
        _prCargarProductos(cbCategoriaProducto.Value)
    End Sub
    ...
    Private Sub TextBoxX1_TextChanged(sender As Object, e As EventArgs) Handles tbNameCliente.TextChanged
    ...
    Private Sub btnClientes_Click(sender As Object, e As EventArgs) Handles btnClientes.Click
        ...
        If (bandera = True) Then
            ...
            tbNameCliente.Text = Row.Cells("NombreProveedor").Value
            cbFechaDesde.Focus()
