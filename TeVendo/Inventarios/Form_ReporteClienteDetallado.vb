...
Public Class Form_ReporteClienteDetallado
    ...
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE DE VENTAS DETALLADAS REALIZADAS"
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        If (chkTodos.Checked = True) Then
            ...
            dt = ReporteVentasAtendidasTodosDetallado(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        Else
            If (IdPersonal > 0) Then

                dt = ReporteVentasAtendidasTodosDetallado(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))

                Dim dtfiltrada As DataTable = dt.Copy
                dtfiltrada.Rows.Clear()

                For i As Integer = 0 To dt.Rows.Count - 1 Step 1

                    If (dt.Rows(i).Item("ClienteId") = IdPersonal) Then
