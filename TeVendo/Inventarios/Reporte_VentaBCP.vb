...
Public Class Reporte_VentaBCP
    ...
    Public Sub GenerarData(ByRef dt As DataTable)
        ...
        If (chkTodos.Checked = True) Then
            ...
            dt = ReporteVentasUtilidadesTodosServicios(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"))
        Else
            If (IdPersonal > 0) Then

                dt = ReporteVentasUtilidadesTodosUnVendedorServicios(cbFechaDesde.Value.ToString("yyyy/MM/dd"), cbFechaHasta.Value.ToString("yyyy/MM/dd"), IdPersonal)
            Else
                tbVendedor.Focus()
    ...
    Private Sub ButtonX1_Click(sender As Object, e As EventArgs) Handles ButtonX1.Click
        If (swTipoReporte.Value = True) Then ''' Generar Reporte de Datos
            ...
            If (_dt.Rows.Count > 0) Then
                ...
                Dim objrep As New Reporte_VentasBCP
