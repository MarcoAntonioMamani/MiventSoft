...
Imports System.IO
Public Class Form_ReporteInventarioPrecio
    ...
    Public Sub IniciarTodod()
        _prCargarProductos()
        _habilitarFocus()
        Me.Text = "Formulario Inventario Precios"
        tbProducto.Focus()
    End Sub
    ...
    Private Sub _prCargarProductos()
        ...
        dt = L_prListarProductosLotePreciosGeneral()  ''1=Almacen
        dtProductos = dt
        ...
        With grProducto.RootTable.Columns("PrecioCosto")
            ...
            .WordWrap = True
        End With
        With grProducto.RootTable.Columns("PrecioLista")
            .Width = 90
            .Visible = True
            .FormatString = "0.00"
            .Caption = "P.Lista"
        ...
        With grProducto.RootTable.Columns("Existencia")
            .Width = 90
            .Visible = True
            .FormatString = "0.00"
            .Caption = "Existencia"
    ...
    Private Sub btnProductos_Click(sender As Object, e As EventArgs) Handles btnProductos.Click
        ...
        _dt = L_prListarProductosLotePreciosGeneral()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New ReporteStockGeneralPrecios
